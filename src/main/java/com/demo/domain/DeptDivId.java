...
public class DeptDivId {
	...
	@Column( name = "DeptDivId_name")
	private String name;
	
	@Column( name = "DeptDivId_label")
	private String label;
	
	@Column( name = "DeptDivId_description")
	private String description;
	
	@Column( name = "DeptDivId_dataTypeDefnId")
    ...
    @Column( name = "DeptDivId_tenantId")
